...
const STRINGS = {
  ru: {
    ...
    pay_card_store: "Картой в магазине",
    pay_transfer: "Перевод",
    pay_paypal: "Картой (PayPal)",
    pay_choose_currency: "Выберите валюту оплаты",
    pay_online_hint: "Оплата откроется в браузере. После оплаты вернитесь сюда — статус обновится сам.",
    awaiting_pay_title: "Ожидаем оплату",
    awaiting_pay_sub: "Заказ №{n} создан. Оплатите, чтобы мы приступили к сборке.",
    pay_now: "Оплатить {amount}",
    pay_open: "Открыть оплату снова",
    pay_checking: "Проверяем оплату…",
    pay_i_paid: "Я оплатил — проверить",
    payment_success: "Оплата получена ✅",
    payment_success_sub: "Заказ №{n} принят в работу.",
    payment_failed: "Оплата не завершена",
    payment_failed_sub: "Похоже, оплата не прошла. Можно попробовать снова.",
    pay_retry: "Попробовать снова",
    pay_start_err: "Не удалось начать оплату, попробуйте ещё раз",
    ...
    out_of_stock: "Нет в наличии — уточните у менеджера",
    out_of_stock_short: "Нет в наличии",
    size_unavailable: "Этот размер закончился — выберите другой",
    from_price: "от",
    on_request: "по запросу",
    price_request: "Стоимость по запросу",
    ask_manager: "Уточнить у менеджера",
  ...
  en: {
    ...
    pay_card_store: "Card in store",
    pay_transfer: "Bank transfer",
    pay_paypal: "Card (PayPal)",
    pay_choose_currency: "Choose payment currency",
    pay_online_hint: "Payment opens in your browser. After paying, come back here — the status updates automatically.",
    awaiting_pay_title: "Awaiting payment",
    awaiting_pay_sub: "Order #{n} created. Pay so we can start preparing it.",
    pay_now: "Pay {amount}",
    pay_open: "Open payment again",
    pay_checking: "Checking payment…",
    pay_i_paid: "I've paid — check",
    payment_success: "Payment received ✅",
    payment_success_sub: "Order #{n} is now in progress.",
    payment_failed: "Payment not completed",
    payment_failed_sub: "Looks like the payment didn't go through. You can try again.",
    pay_retry: "Try again",
    pay_start_err: "Couldn't start the payment, please try again",
    ...
    out_of_stock: "Out of stock — ask the manager",
    out_of_stock_short: "Out of stock",
    size_unavailable: "This size is out — choose another",
    from_price: "from",
    on_request: "on request",
    price_request: "Price on request",
    ask_manager: "Ask the manager",
    write_manager: "Message the manager",
